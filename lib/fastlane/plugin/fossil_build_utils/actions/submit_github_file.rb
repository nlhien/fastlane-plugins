module Fastlane
  module Actions
    module SharedValues
      SUBMIT_GITHUB_FILE_HTML_LINK = :SUBMIT_GITHUB_FILE_HTML_LINK
      SUBMIT_GITHUB_FILE_SHA = :SUBMIT_GITHUB_FILE_SHA
      SUBMIT_GITHUB_FILE_JSON = :SUBMIT_GITHUB_FILE_JSON
    end

    class SubmitGithubFileAction < Action

      def self.commit_github_file(params)
      ...
      def self.run(params)
        ...
        Actions.lane_context[SharedValues::SUBMIT_GITHUB_FILE_JSON]
      end
      ...
      def self.available_options
        [
          FastlaneCore::ConfigItem.new(key: :repository_name,
                                       env_name: "FL_SUBMIT_GITHUB_FILE_REPOSITORY_NAME",
          ...
          FastlaneCore::ConfigItem.new(key: :server_url,
                                       env_name: "FL_SUBMIT_GITHUB_FILE_SERVER_URL",
          ...
          FastlaneCore::ConfigItem.new(key: :api_token,
                                       env_name: "FL_SUBMIT_GITHUB_FILE_API_TOKEN",
      ...
      def self.output
        [
          ['SUBMIT_GITHUB_FILE_HTML_LINK', 'Link to your committed file'],
          ['SUBMIT_GITHUB_FILE_SHA', 'Commit SHA generated'],
          ['SUBMIT_GITHUB_FILE_JSON', 'The whole commit JSON object response']
        ]
      end
